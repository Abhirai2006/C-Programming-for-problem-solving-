...
void main()
{
    ...
    printf("\n");
    printf("The third array after combining in the same order is:\n");
    for(int i=0; i<n3; i++)
    {
        printf("%d ",arr3[i]);
    }
    ...
    // Printing the merged array after sorting

    printf("\nThe third array after combining in ascending order is:");
    for(int i=0; i<n3; i++)
    {
        printf("%d ",arr3[i]);
    }
